                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="fa fa-puzzle-piece"></i><a href="{{ url('edulevels') }}">Edulevel</a></li>
                            <li><i class="fa fa-puzzle-piece"></i><a href="{{ url('programs') }}">Program</a></li>
                            {{-- <li>
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa ti-share"></i><a href="page-login.html">Login</a></li>
                                <li><i class="menu-icon fa ti-new-window"></i><a href="page-register.html">Register</a></li>
                                <li><i class="menu-icon fa ti-help-alt"></i><a href="pages-forget.html">Forget Pass</a></li>
                            </ul>
                        </li>
                    </li>
                </ul>

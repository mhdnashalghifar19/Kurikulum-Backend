...
class OperasiHitung{
    ...
    public static function keliling_lingkaran($r){
        return (2*3.14*$r);
    }
...
switch ($pilih) {
    case '1':
        ...
        echo "luasnya = ".OperasiHitung::luas_lingkaran($jari_jari);
        break;
    case '2':
        echo "=================================== \n";
        ...
        echo "jari-jari = ";
        $jari_jari=trim(fgets(STDIN));
        echo "kelilingnya = ".OperasiHitung::keliling_lingkaran($jari_jari);
        break;
    case '3':
        echo "=================================== \n";
        echo "|          Luas Trapesium         | \n";
        ...
        echo "luasnya = ".OperasiHitung::luas_trapesium($alasatas, $alasbawah, $tinggi);
        break;
    case '4':
        echo "===================================== \n";
        ...
        echo "kelilingnya = ".OperasiHitung::keliling_trapesium($sisi1, $sisi2, $sisi3, $sisi4);
        break;    
